...
| C-11 UAS well-clear and DAA alerting metrics | implemented | ASTM-F3442, RTCA-DO365, ICAO-A2 | DAA-001, DAA-002, DAA-003, DAA-004, DAA-005 | wellclear.py, encounters.py, risk.py, trend.py | test_uas.py, test_feeds_risk.py | ST-07, ST-16, ST-21 |
| C-12 UTM API conformance | implemented | ASTM-F3411 |  | utm.py, utm.py | test_gap_fill.py, test_uas.py | ST-09 |
| C-33 External asset integrity and provenance | implemented | NASA-NOSA-1.3, NASA-MEDIA |  | nasa3d.py, nasa_images.py | test_space.py |  |
| C-34 Crisis extent to operations impact | implemented | NASA-NPR-8715.3, ICAO-A11 |  | nws_alerts.py | test_gap_fill.py, test_governance.py | ST-11 |
...
| C-20 Study registry with provenance | implemented | NASA-SLIM |  | studies.py | test_governance.py | ST-03, ST-04 |
| C-21 Encounter and collision-risk modelling | implemented | ASTM-F3442 |  | encounters.py, encounter_model.py | test_uas.py, test_depth.py | ST-08, ST-19 |
| C-22 Provenance and manifests on every report | implemented | NIST-SP800-53, ISO-27001 |  | generic_report.py, provenance.py | test_generic_report_demo.py, test_provenance_and_tour.py |  |
...
| C-41 Integration inventory | implemented | NIST-SP800-53, ISO-27001 |  | livecheck.py, integrations.py | test_livecheck.py, test_feeds_risk.py |  |
...
| C-45 Space-operations airspace joined to traffic | implemented | CFR14-91.143, CFR14-450, ICAO-A11 | TFR-001, TFR-002, TFR-003 | tfr.py, airspace.py | test_airspace.py | ST-22 |
