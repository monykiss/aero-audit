...
| C-08 | Launch telemetry plausibility | partial | space-launch | CCSDS-133, CFR14-450 | rule:SPC-001; rule:SPC-002; rule:SPC-003; rule:SPC-004; rule:SPC-005; module:aero_audit/space/telemetry.py; module:aero_audit/space/footage.py; test:tests/test_space.py; test:tests/test_gap_fill.py; command:aero space telemetry-audit; command:aero space frames |
...
| C-33 | External asset integrity and provenance | implemented | space-assets | NASA-NOSA-1.3, NASA-MEDIA | module:aero_audit/uas/utm.py; command:aero uas utm-fetch; test:tests/test_gap_fill.py; module:aero_audit/space/nasa3d.py; module:aero_audit/space/nasa_images.py; test:tests/test_space.py; command:aero space fetch |
