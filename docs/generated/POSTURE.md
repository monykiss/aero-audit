...
Governance index: **72%** (controls 73%, standards 64%, risk share low/medium 90%, studies runnable 50%). Basis: baseline (no session evidence).
...
| Air: operations, airports and ecosystem | active | 11 | 10 / 2 / 0 | adsb.lol / OpenSky; NOAA AWC METAR; FAA NAS status XML; bundled airport / operator / type tables; apron imagery |
...
| S06 | space-orbital | Mission design non-compliant with debris mitigation rules | 8 medium | 8 medium |
| S07 | space-orbital | Unauthenticated space data link accepted as truth | 8 medium | 8 medium |
...
| U02 | uas-utm | UTM exchanges non-conformant with the published API contracts | 6 medium | 6 medium |
...
By residual rating: {'critical': 2, 'high': 0, 'medium': 10, 'low': 7}
