...
SUMMARIES: dict[tuple[str, str], tuple[str, str, str]] = {
    ...
    ("POST", "/api/v1/jobs"): ("Submit a job", "Body {\"type\": capture|audit_session|audit_recording|train|evaluate|prune|docs_build|corroborate|cdm_inbox|spacetrack_pull|conjunctions|space_weather|launches|wellclear|uas_risk|catalog_build|maneuvers|encounter_model|satcat, \"params\": {...}}.", "jobs"),
