...
STANDARDS: dict[str, Standard] = {s.id: s for s in (
    ...
    Standard("CFR14-91.143", "14 CFR 91.143 Flight limitation in the proximity of space flight operations", "FAA", "air", "Airspace restrictions around launch and reentry windows", "https://www.ecfr.gov/current/title-14/section-91.143"),
    Standard("ICAO-A3", "ICAO Annex 3, Meteorological Service (space weather advisories, Amdt 78+)", "ICAO", "air", "Global space weather centre advisories: HF, GNSS, radiation at moderate / severe"),
    Standard("NOAA-SCALES", "NOAA Space Weather Scales (R / S / G)", "NOAA SWPC", "space", "Radio blackout, solar radiation storm and geomagnetic storm levels 1-5", "https://www.swpc.noaa.gov/noaa-scales-explanation"),
