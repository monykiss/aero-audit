...
CONTROLS: dict[str, Control] = {c.id: c for c in (
    ...
    Control("C-31", "Software assurance classification", "Components classified per NPR 7150.2 with the activities each class implies; SLIM repository checklist evaluated on the tree.",
            "governance", ("space-launch", "space-orbital", "air-surveillance"), ("NASA-NPR-7150.2", "NASA-STD-8739.8", "NASA-SLIM"), "implemented",
            ("module:aero_audit/governance/assurance.py", "module:aero_audit/governance/reviews.py", "test:tests/test_assurance_catalog.py", "test:tests/test_release_1_0.py", "command:aero gov assurance",
             "command:aero gov reviews", "artefact:docs/generated/ASSURANCE.md", "artefact:docs/generated/REVIEWS.md", "artefact:docs/assurance/review_log.json"),
            notes="Every component carries a dated review record with a cadence by class and safety relevance; self-reviews are labelled as such and never counted as peer reviews; automatic checks (tests importing the component, lint, CodeQL, fuzzing, traceability, documentation) are attached as evidence."),
    Control("C-32", "Space data link security expectations", "SDLS expectations stated for any spacecraft telemetry ingested; authentication status to be recorded per packet.",
            "governance", ("space-orbital", "space-launch"), ("CCSDS-355",), "implemented",
            ("module:aero_audit/governance/assurance.py", "module:aero_audit/space/sdls.py", "rule:SPC-006", "rule:SPC-007", "rule:SPC-008", "artefact:docs/generated/ASSURANCE.md",
             "artefact:data/samples/sdls_packets_sample.json", "test:tests/test_assurance_catalog.py", "test:tests/test_release_1_0.py", "command:aero space telemetry-audit"),
            notes="Packet streams carry SPI, sequence and MAC; HMAC-SHA256 verification per packet with keys from the environment, anti-replay on the sequence; every telemetry report records the authentication status of its transport. NASA CryptoLib remains the reference for the link itself."),
    ...
    Control("C-45", "Space-operations airspace joined to traffic", "Published space-operations TFRs (geometry, effective time, vertical limits) fetched keyless and joined to recorded traffic and to launch windows: aircraft inside a restriction in effect, US windows without one, stale products.",
            ...
            ("rule:TFR-001", "rule:TFR-002", "rule:TFR-003", "module:aero_audit/ingest/tfr.py", "module:aero_audit/space/airspace.py", "module:aero_audit/space/capture.py", "test:tests/test_airspace.py", "test:tests/test_capture.py", "command:aero space tfr", "command:aero space launch-capture", "study:ST-22", "study:ST-25", "doc:docs/SPACE.md"), cadence_days=30),
