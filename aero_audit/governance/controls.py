...
CONTROLS: dict[str, Control] = {c.id: c for c in (
    ...
    Control("C-33", "External asset integrity and provenance", "NASA-3D assets verified against git blob ids; library downloads hashed; sidecars and manifests.",
            ...
            ("module:aero_audit/uas/utm.py", "command:aero uas utm-fetch", "test:tests/test_gap_fill.py", "module:aero_audit/space/nasa3d.py", "module:aero_audit/space/nasa_images.py", "test:tests/test_space.py", "command:aero space fetch")),
    ...
    Control("C-22", "Provenance and manifests on every report", "Code commit, input hash, model hash, evaluation hash, threshold overrides; SHA-256 per file.",
            ...
            ("module:aero_audit/ingest/nws_alerts.py", "command:aero data crisis-fetch", "test:tests/test_gap_fill.py", "module:aero_audit/provenance.py", "artefact:reports/*.manifest.json", "command:aero log verify-report", "test:tests/test_provenance_and_tour.py")),
