...
INTEGRATIONS: dict[str, Integration] = {i.key: i for i in (
    ...
    Integration("spacetrack", "Space-Track.org", ("SPACETRACK_USER", "SPACETRACK_PASS"), "https://www.space-track.org/auth/createAccount (free; approval takes a day or two)",
                "Optional: cdm_public summaries, GP history, TIP messages. Its user agreement forbids redistributing the data or analyses of it.",
                "CelesTrak GP + our SGP4 screen (conjunctions), cached GP snapshots (history), CelesTrak SATCAT (decay dates): every capability keyless", ("space-orbital",)),
    Integration("satcat", "CelesTrak SATCAT", (), "none", "Object identity, owner, type, orbit and decay dates for the whole catalogue; ORB-008.", "fully keyless, daily CSV", ("space-orbital",)),
